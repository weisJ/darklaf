 ...
 * @author atarw
 */
public class DarkTableCellRendererRadioButton extends JRadioButton implements TableCellRenderer, SwingConstants {

    private boolean hasFocus;

    public DarkTableCellRendererRadioButton() {
        this(false);
    }


    public DarkTableCellRendererRadioButton(final boolean selected) {
